        ...
        <div class="p-6 space-y-6 flex-1 overflow-y-auto">
            ...
            <div id="uploader-tab-manager" class="uploader-tab-content">
                ...
                <div id="uploader-file-grid"
                    class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6 relative">
                    <!-- Loader overlay -->
                    <div id="uploader-file-grid-loader"
                        class="absolute inset-0 flex items-center justify-center bg-white/80 z-40">
